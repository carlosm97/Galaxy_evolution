...
runcell('Models & plotting functions', '/home/carlos/Desktop/Paper_TFG/TFG2/plots.py')
kwargs = {'wind': 2}   
tau_0 = models.model_run(S_I,  K=.015, include_atom =1, tau_I=1e-3,model_type='variable', eta_dis=100,**kwargs)
tau_2 = models.model_run(S_I,  K=.015, include_atom =1, tau_I=2.,model_type='variable', eta_dis=100,**kwargs)
tau_4 = models.model_run(S_I,  K=.015, include_atom =1, tau_I=4.,model_type='variable', eta_dis=100,**kwargs)
tau_inf = models.model_run(S_I, K=.015, include_atom =1, tau_I=1e3,model_type='variable', eta_dis=100,**kwargs)
# K=50.,
...
del plot_list,tau_0,tau_2,tau_4,tau_inf,model_list
# <codecell> Running selecten models. 
'''
plt.close('all')
